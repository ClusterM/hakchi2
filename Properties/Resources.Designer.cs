...
namespace com.clusterrr.hakchi_gui.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Total writable memory size: {0:F1}MBytes|Available memory for games: {1:F1}MBytes|Used by save-states: {2:F1}MBytes|Used by other files: {3:F1}MBytes.
        /// </summary>
