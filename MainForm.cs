...
namespace com.clusterrr.hakchi_gui
{
    public partial class MainForm : Form
    {
        ...
        static NesDefaultGame[] defaultNesGames = new NesDefaultGame[] {
            new NesDefaultGame { Code = "CLV-P-NAAAE",  Name = "Super Mario Bros.", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAACE",  Name = "Super Mario Bros. 3", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAADE",  Name = "Super Mario Bros. 2",Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAEE",  Name = "Donkey Kong", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAFE",  Name = "Donkey Kong Jr." , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAHE",  Name = "Excitebike", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAANE",  Name = "The Legend of Zelda", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAPE",  Name = "Kirby's Adventure", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAQE",  Name = "Metroid", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAARE",  Name = "Balloon Fight", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAASE",  Name = "Zelda II - The Adventure of Link", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAATE",  Name = "Punch-Out!! Featuring Mr. Dream", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAUE",  Name = "Ice Climber", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAVE",  Name = "Kid Icarus", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAWE",  Name = "Mario Bros.", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAXE",  Name = "Dr. MARIO", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NAAZE",  Name = "StarTropics", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABBE",  Name = "MEGA MAN™ 2", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABCE",  Name = "GHOSTS'N GOBLINS™", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABJE",  Name = "FINAL FANTASY®", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABKE",  Name = "BUBBLE BOBBLE" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABME",  Name = "PAC-MAN", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABNE",  Name = "Galaga", Size =  24576 },
            new NesDefaultGame { Code = "CLV-P-NABQE",  Name = "Castlevania", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABRE",  Name = "GRADIUS", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABVE",  Name = "Super C", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NABXE",  Name = "Castlevania II Simon's Quest", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NACBE",  Name = "NINJA GAIDEN", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NACDE",  Name = "TECMO BOWL", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-NACHE",  Name = "DOUBLE DRAGON II: The Revenge", Size = 24576 }
        };
        static NesDefaultGame[] defaultFamicomGames = new NesDefaultGame[] {
            new NesDefaultGame { Code = "CLV-P-HAAAJ",  Name = "スーパーマリオブラザーズ", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAACJ",  Name = "スーパーマリオブラザーズ３", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAADJ",  Name = "スーパーマリオＵＳＡ", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAAEJ",  Name = "ドンキーコング" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAAHJ",  Name = "エキサイトバイク" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAAMJ",  Name = "マリオオープンゴルフ" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAANJ",  Name = "ゼルダの伝説", Size = 24576  },
            new NesDefaultGame { Code = "CLV-P-HAAPJ",  Name = "星のカービィ　夢の泉の物語" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAAQJ",  Name = "メトロイド" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAARJ",  Name = "バルーンファイト" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAASJ",  Name = "リンクの冒険" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAAUJ",  Name = "アイスクライマー" , Size = 24576    },
            new NesDefaultGame { Code = "CLV-P-HAAWJ",  Name = "マリオブラザーズ" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HAAXJ",  Name = "ドクターマリオ" , Size = 24576   },
            new NesDefaultGame { Code = "CLV-P-HABBJ",  Name = "ロックマン®2 Dr.ワイリーの謎" , Size = 24576  },
            new NesDefaultGame { Code = "CLV-P-HABCJ",  Name = "魔界村®", Size = 24576    },
            new NesDefaultGame { Code = "CLV-P-HABLJ",  Name = "ファイナルファンタジー®III" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HABMJ",  Name = "パックマン" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HABNJ",  Name = "ギャラガ", Size =  24576 },
            new NesDefaultGame { Code = "CLV-P-HABQJ",  Name = "悪魔城ドラキュラ" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HABRJ",  Name = "グラディウス", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HABVJ",  Name = "スーパー魂斗羅" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACAJ",  Name = "イー・アル・カンフー", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACBJ",  Name = "忍者龍剣伝" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACCJ",  Name = "ソロモンの鍵" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACEJ",  Name = "つっぱり大相撲", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACHJ",  Name = "ダブルドラゴンⅡ The Revenge", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACJJ",  Name = "ダウンタウン熱血物語" , Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACLJ",  Name = "ダウンタウン熱血行進曲 それゆけ大運動会", Size = 24576 },
            new NesDefaultGame { Code = "CLV-P-HACPJ",  Name = "アトランチスの謎", Size = 24576 }
        };
