...
namespace com.clusterrr.hakchi_gui
{
    public class NesGame : NesMiniApplication
    {
        ...
        public static NesMiniApplication Import(string nesFileName, string zFileName, bool? ignoreMapper, ref bool? needPatch, NeedPatchDelegate needPatchCallback = null, Form parentForm = null, byte[] rawRomData = null)
        {
            NesFile nesFile;
            try
            {
            ...
            {
                return NesMiniApplication.Import(nesFileName, zFileName, rawRomData);
            }
            nesFile.CorrectRom();
            ...
            game.FindCover(nesFileName, zFileName, (game.region == "Japan") ? Resources.blank_jp : Resources.blank_nes, crc32);
