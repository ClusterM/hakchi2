namespace com.clusterrr.hakchi_gui
{
    public static class BuiltInCores
    {
        public readonly static CoreCollection.CoreInfo[] List = new CoreCollection.CoreInfo[] {
            new CoreCollection.CoreInfo("clover-canoe-shvc-wr -rom")
            {
            ...
            new CoreCollection.CoreInfo("clover-kachikachi-wr")
            {
            ...
            new CoreCollection.CoreInfo("hsqs")
            {
            ...
            new CoreCollection.CoreInfo("sh")
            {
                DefaultArgs = string.Empty,
                Name = "Bash",
